(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["stream-score-board~user-score-board"],{
...
/***/ "./resources/js/mixins/score-board/index.js":
/*!**************************************************!*\
  !*** ./resources/js/mixins/score-board/index.js ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _score_board__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./score-board */ "./resources/js/mixins/score-board/score-board.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _score_board__WEBPACK_IMPORTED_MODULE_0__["default"]; });



/***/ }),

/***/ "./resources/js/mixins/score-board/score-board.js":
/*!********************************************************!*\
  !*** ./resources/js/mixins/score-board/score-board.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var lodash_es_chunk__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash-es/chunk */ "./node_modules/lodash-es/chunk.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapState"])(_configs_store_modules__WEBPACK_IMPORTED_MODULE_2__["common"], ['rankGroups']), {
    groupedRank: function groupedRank() {
      if (!this.isRankGrouped) return this.rank.data;
      var rankGroups = this.rankGroups.data;
      var rank = this.rank.data;
      var rankGroupsCount = rankGroups.length;
      var rankCount = rank.length;
      var remains = rankCount % rankGroupsCount;
      var memberCount = remains === rankGroupsCount - 1 ? Math.ceil(rankCount / rankGroupsCount) : Math.floor(rankCount / rankGroupsCount);
      var chunked = Object(lodash_es_chunk__WEBPACK_IMPORTED_MODULE_0__["default"])(rank, memberCount);

      if (rankGroupsCount > 0 && chunked.length > rankGroupsCount) {
        var _chunked;

        (_chunked = chunked[rankGroupsCount - 1]).push.apply(_chunked, _toConsumableArray(chunked[rankGroupsCount]));
      }

      var finalChunked = chunked.slice(0, rankGroupsCount);
      var groupedRank = finalChunked.map(function (members, index) {
        return {
          members: members,
    ...
    isRankGrouped: function isRankGrouped() {
      var rankGroups = this.rankGroups.data;
      var rank = this.rank.data;
